...
Currently is implemented Flyway database migration with `io.github.balconyseats.vertx.helper.database.migration.ConfigFlywayDatabaseMigration`.
...
Configuration uses database as parent and use properties from database such as user, password, host, etc..:
